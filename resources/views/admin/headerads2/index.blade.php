...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            ...
            @endif
            <div class="card card-header">All Header-2 Advertisement Size:1170x100</div>
                            ...
                            <td class="text-right">
                                <div class="dropdown show d-inline-block widget-dropdown">
                                    ...
                                    <li class="dropdown-item">
                                        <a href="{{ url('/header2/edit/'.$ad->id) }}">Edit</a>
                                    </li>
                                    <li class="dropdown-item">
                                        <a href="{{ url('/header2/delete/'.$ad->id) }}">Delete</a>
                                    </li>
                                    </ul>
                                </div>
                            </td>
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card card-header">Add Header-2 Advertisement</div>
            <div class="card card-body">
                <form action="{{ route('store.header2')}}" method="POST" enctype="multipart/form-data">
                    @csrf
