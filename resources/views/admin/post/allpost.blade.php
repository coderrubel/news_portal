                            ...
                            <td class="text-right">
                                <div class="dropdown show d-inline-block widget-dropdown">
                                    ...
                                    <li class="dropdown-item">
                                        <a href="{{ url('post/edit/'.$row->id) }}"><span class="btn btn-sm btn-info">Edit</span></a>
                                    </li>
                                    <li class="dropdown-item">
                                        <a href="{{ url('softdelete/post/'.$row->id) }}"><span class="btn btn-sm btn-danger">Remove</span></a>
                                    </li>
                                    </ul>
                                </div>
                            </td>
