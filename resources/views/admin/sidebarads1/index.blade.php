                        ...
                        <td class="text-right">
                            <div class="dropdown show d-inline-block widget-dropdown">
                                ...
                                <li class="dropdown-item">
                                    <a href="{{ url('/sidebar1/edit/'.$ad->id) }}">Edit</a>
                                </li>
                                <li class="dropdown-item">
                                    <a href="{{ url('/sidebar1/delete/'.$ad->id) }}">Delete</a>
                                </li>
                                </ul>
                            </div>
                        </td>
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card card-body">
                <form action="{{ route('store.sidebar1')}}" method="POST" enctype="multipart/form-data">
                    @csrf
