                ...
                <div class="col-md-10">
                    <div class="card">
                        ...
                        <div class="card card-body">
                            <form action="{{ url('subcategory/update/'.$subcagagorys->id) }}" method="POST">
                                @csrf
                                <div class="my-2">
                                    ...
                                    @error('category_name')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror    
                                    <input type="text" name="category_name" value="{{ $subcagagorys->sub_category_name }}" class="form-control rounded" id="addcategory" placeholder="Update Sub Category Name">
                                    <label for="addcategory" class="form-label mt-2 mb-0">Update Category Order</label>
                                    @error('sub_catagory_order')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror   
                                    <input type="text" name="catagory_order" value="{{ $subcagagorys->sub_catagory_order }}" class="form-control rounded mt-2" id="order" placeholder="Sub Catagory Order">
